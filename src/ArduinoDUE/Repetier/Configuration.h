...
#define ZAXIS_STEPS_PER_MM 6425.38
...
#define X2_STEP_PIN   ORIG_X_STEP_PIN
#define X2_DIR_PIN    ORIG_X_DIR_PIN
#define X2_ENABLE_PIN ORIG_X_ENABLE_PIN
#define FEATURE_TWO_YSTEPPER 0
#define Y2_STEP_PIN   ORIG_Y_STEP_PIN
#define Y2_DIR_PIN    ORIG_Y_DIR_PIN
#define Y2_ENABLE_PIN ORIG_Y_ENABLE_PIN
#define FEATURE_TWO_ZSTEPPER 0
#define Z2_STEP_PIN   ORIG_Z_STEP_PIN
#define Z2_DIR_PIN    ORIG_Z_DIR_PIN
#define Z2_ENABLE_PIN ORIG_Z_ENABLE_PIN
#define FEATURE_THREE_ZSTEPPER 0
#define Z3_STEP_PIN   ORIG_Z_STEP_PIN
#define Z3_DIR_PIN    ORIG_Z_DIR_PIN
#define Z3_ENABLE_PIN ORIG_Z_ENABLE_PIN
#define FEATURE_FOUR_ZSTEPPER 0
#define Z4_STEP_PIN   ORIG_Z_STEP_PIN
#define Z4_DIR_PIN    ORIG_Z_DIR_PIN
#define Z4_ENABLE_PIN ORIG_Z_ENABLE_PIN
...
#define UI_PRINTER_COMPANY "Alex"
