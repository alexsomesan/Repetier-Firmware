...
STEPPER_TMC2209_SW_UART(XMotor, IOX1Step, IOX1Dir, IOX1Enable, X_SW_SERIAL_TMC_PIN, X_SW_SERIAL_TMC_PIN, 0.1f, 16, 550, 0, 0, 0, 8, 12, endstopXMin, endstopNone)
STEPPER_TMC2209_SW_UART(YMotor, IOY1Step, IOY1Dir, IOY1Enable, Y_SW_SERIAL_TMC_PIN, Y_SW_SERIAL_TMC_PIN, 0.1f, 16, 550, 0, 0, 0, 8, 12, endstopYMin, endstopNone)
STEPPER_TMC2209_SW_UART(ZMotor, IOZ1Step, IOZ1Dir, IOZ1Enable, Z_SW_SERIAL_TMC_PIN, Z_SW_SERIAL_TMC_PIN, 0.1f, 16, 550, 0, 0, 0, 8, 12, endstopNone, endstopNone)
STEPPER_TMC2209_SW_UART(E1MotorBase, IOE1Step, IOE1Dir, IOE1Enable, E0_SW_SERIAL_TMC_PIN, E0_SW_SERIAL_TMC_PIN, 0.1f, 16, 650, 0, 0, 0, 8, 12, endstopNone, endstopNone)
